...
function GradientMeshInner({
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      color = mix(color, uColor4, sin(uTime * 0.5) * 0.5 + 0.5);
  ...
  return (
    <mesh ref={meshRef} scale={[5, 5, 1]} position={[0, 0, -2]}>
...
export function GradientMeshBackground(props: GradientMeshProps) {
  return (
    <div
      style={{
        position: "fixed",
